/**
 * Navbar for the admin user directory (`/admin`).
 * Mirrors Navbar-Home: Surveys + Admin links and account menu.
 */
...
export default function NavbarAdmin({ isDarkMode, onToggleDarkMode, accent, onSetAccent, locale, onCycleLocale }) {
      ...
      <div className="container-fluid">
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            {isAdmin() && (
              <li className="nav-item">
                <Link to="/admin" className="nav-link active me-2">
                  <T k="nav.admin" />
                </Link>
              </li>
            )}
