/**
 * Navbar for the survey editor (`/editor`, `/editor/:formId`).
 * Same account/logout pattern as Navbar-Surveys, with Survey Editor as the active link.
 */
...
export default function NavbarEditor({ isDarkMode, onToggleDarkMode, accent, onSetAccent, locale, onCycleLocale }) {
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            <li className="nav-item">
              <Link to="/surveys" className="nav-link me-2">
                <T k="nav.surveys" />
              </Link>
            </li>
            {isAdmin() && (
            ...
            <li className="nav-item">
              <Link to="/editor" className="nav-link active me-2">
                <T k="nav.editor" />
              </Link>
            </li>
          </ul>
