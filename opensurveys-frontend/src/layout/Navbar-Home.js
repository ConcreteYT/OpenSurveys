/**
 * Authenticated dashboard navbar (`/login-home`).
 * Links to Surveys, Survey Editor, and provides an account menu
 * (theme, accent, settings, logout).
 */
...
export default function NavbarHome({ isDarkMode, onToggleDarkMode, accent, onSetAccent, locale, onCycleLocale }) {
